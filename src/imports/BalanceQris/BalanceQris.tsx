...
import { SALDO_QRIS, formatRp } from "../../data/saldo";
...
import svgPaths from "./svg-e8tufq6w7a";
...
function Frame29({ onOpenTray }: { onOpenTray: () => void }) {
  return (
    <button onClick={onOpenTray} className="bg-[#a6e8ff] content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0 cursor-pointer border-none">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full">
      ...
      <p className="font-['Maison_Neue_APP:Bold',sans-serif] leading-[44px] relative shrink-0 text-[#1c1d1d] text-[28px] w-full">{formatRp(SALDO_QRIS)}</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Saldo">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[12px] py-[16px] relative size-full">
        <Frame />
        <div className="bg-[#008a0d] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[18px] shrink-0" data-name="button/primary">
          <div className="content-stretch flex items-center justify-center relative shrink-0" data-name=".properties/button/label/tiny">
            <p className="font-['Maison_Neue_APP:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Cairkan</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame25({ onOpenTray }: { onOpenTray: () => void }) {
  return (
  ...
  return (
    <div className="h-[56px] relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[12px] py-[16px] relative size-full">
          <Frame1 />
        </div>
      </div>
    </div>
...
function Frame4({ onOpenKompensasi }: { onOpenKompensasi: () => void }) {
  return (
    <button onClick={onOpenKompensasi} className="cursor-pointer relative shrink-0 w-full bg-transparent border-none p-0 text-left">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-between px-[12px] py-[16px] relative size-full">
          <p className="font-['Maison_Neue_APP:Book',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4c4c4c] text-[13px] w-[70px]">Kompensasi</p>
          <Frame17 />
        </div>
      </div>
    </button>
...
function Frame15({ onOpenKompensasi, onOpenPemotongan }: { onOpenKompensasi: () => void; onOpenPemotongan: () => void }) {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[16px] shrink-0 w-full">
      ...
      <Frame4 onOpenKompensasi={onOpenKompensasi} />
      <div className="h-px relative shrink-0 w-full" data-name="divider">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center pl-[12px] relative size-full">
            <div className="flex-[1_0_0] h-0 min-w-px relative" data-name="dotted_divider">
...
function Frame40({ onOpenPencairan }: { onOpenPencairan: () => void }) {
  return (
    <div className="relative shrink-0 w-full">
...
function Frame20({ onOpenPencairan, onOpenDetail }: { onOpenPencairan: () => void; onOpenDetail: (item: PayoutItem) => void }) {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[16px] shrink-0 w-full">
      ...
      <Frame40 onOpenPencairan={onOpenPencairan} />
    </div>
  );
}
...
export default function BalanceQris() {
  ...
  return (
    <div className="bg-[#f2f2f4] relative rounded-[16px] size-full overflow-hidden">
      ...
      {showPemotongan && <RiwayatPemotonganTray type="qris" onClose={() => setShowPemotongan(false)} />}
      {showPencairan && <RiwayatPencairanTray type="qris" onClose={() => setShowPencairan(false)} />}
      {selectedPayout && <DetailPencairanOverlay type="qris" item={selectedPayout} onClose={() => setSelectedPayout(null)} />}
    </div>
  );
}