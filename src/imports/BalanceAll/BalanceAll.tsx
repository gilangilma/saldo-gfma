...
import { SALDO_TOTAL, formatRp } from "../../data/saldo";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="icon">
          <g id="bound" />
          <path d={svgPaths.p26c91500} fill="var(--fill-0, #4C4C4C)" id="color" />
        </g>
      </svg>
    </div>
  );
...
function Frame29({ onOpenTray }: { onOpenTray: () => void }) {
  return (
    <button onClick={onOpenTray} className="bg-[#abffa6] content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0 cursor-pointer border-none">
      <div className="content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="payments/16/ic_pinjam">
        <Icon />
      </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full">
      ...
      <p className="font-['Maison_Neue_APP:Bold',sans-serif] leading-[44px] relative shrink-0 text-[#1c1d1d] text-[28px] w-full">{formatRp(SALDO_TOTAL)}</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <p className="font-['Maison_Neue_APP:Demi',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#007c0b] text-[13px] whitespace-nowrap">Cairkan saldo QRIS</p>
  ...
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Saldo">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[12px] py-[16px] relative size-full">
        ...
        <p className="font-['Maison_Neue_APP:Book',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#8b8b8b] text-[13px] whitespace-nowrap">Saldo GoFood cair otomatis besok jam 04:00</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  ...
  return (
    <button onClick={() => navigate("/finance/all/penjualan", { replace: true })} className="cursor-pointer relative shrink-0 w-full bg-transparent border-none p-0 text-left">
