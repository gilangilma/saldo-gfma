import svgPaths from "./svg-d1aojl2wos";
...
function Balance() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Balance">
...
function SaldoGoFood() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex flex-col gap-[12px] items-start justify-center p-[12px] relative rounded-[12px] shrink-0 w-full" data-name="Saldo GoFood">
...
function SaldoGoFood1() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex flex-col h-[216px] items-start justify-between p-[12px] relative rounded-[12px] shrink-0 w-[280px]" data-name="Saldo GoFood">
      <div aria-hidden="true" className="absolute border border-[#e7e7e7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Frame32 />
      <Frame35 />
    </div>
...
function WalletCards() {
  return (
    <div className="content-stretch drop-shadow-[0px_2px_4px_rgba(85,96,113,0.1)] flex gap-[12px] items-center relative shrink-0 w-full" data-name="Wallet cards">
      <SaldoGoFood />
      <SaldoGoFood1 />
    </div>
  );
        ...
        <div className="relative shrink-0 w-full" data-name="page_control/scroll_pagination">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex gap-[8px] items-center justify-center px-[144px] py-[8px] relative size-full">
              <div className="content-stretch flex items-center justify-center relative rounded-[3px] shrink-0" data-name="1st">
                <div className="bg-[#008a0d] h-[6px] relative rounded-[3px] shrink-0 w-[24px]" data-name="pagination active" />
              </div>
              <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="2nd">
                <div className="relative shrink-0 size-[6px]" data-name="pagination inactive">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
                    <circle cx="3" cy="3" fill="var(--fill-0, #BFBFBF)" id="pagination inactive" r="3" />
                  </svg>
                </div>
              </div>
              <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="3rd">
                <div className="relative shrink-0 size-[6px]" data-name="pagination inactive">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
                    <circle cx="3" cy="3" fill="var(--fill-0, #BFBFBF)" id="pagination inactive" r="3" />
                  </svg>
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start pb-[16px] px-[16px] pt-[77px] w-full" data-name="Content">
      <Main />
      <Settings />
      <Education />
...
function Frame41() {
  return (
    <div className="content-stretch flex gap-[8px] items-start leading-[24px] relative shrink-0 text-[18px]">
      ...
      <p className="font-['Maison_Neue_APP:Demi',sans-serif] relative shrink-0">5 Mei 2026</p>
    </div>
  );
}
...
function TopNavbar() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-0 overflow-clip p-[16px] top-0 w-full" data-name="Top navbar">
      <Frame40 />
    </div>
  );
}
...
export default function FinancePage() {
  return (
    <div className="bg-[#f2f2f4] relative rounded-[16px] size-full overflow-hidden" data-name="Finance page">
      ...
      <div className="no-scrollbar absolute top-0 left-0 right-0 bottom-[64px] overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        <div className="relative" style={{ minHeight: "100%" }}>
          <div className="absolute bg-[#00880d] h-[155px] left-0 top-0 w-full" data-name="Background" />
          <TopNavbar />
          <Content />
        </div>
      </div>

      {/* Floating QRIS button — anchored above bottom nav */}
      <div className="absolute bottom-[72px] left-1/2 -translate-x-1/2 bg-[#00880d] content-stretch drop-shadow-[0px_0px_5px_rgba(0,0,0,0.15)] flex gap-[4px] h-[36px] items-center justify-center pl-[8px] pr-[12px] py-[8px] rounded-[24px]" data-name="button/floating">
